...
class StockButton extends Component {
  ...
  getStockButtonNames = () => {
    ...
    axios
      .get("https://financial-portfolio-4be1a.firebaseio.com/allstocks.json")
      .then(res => {
        if (res.data !== null) {
  ...
  selectStock = event => {
    ...
    axios
      .get(
        `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${val}&apikey=AF9R4LM7IEL50XAS`
      )
      .then(res => {
